 ...
 */
 ...
 (function($){
	...
	$.fn.tablePagination = function(settings) {
		var defaults = {  
			firstArrow : (new Image()).src="../../resource/images/tablePagination/first.png",  
			prevArrow : (new Image()).src="../../resource/images/tablePagination/prev.png",
			lastArrow : (new Image()).src="../../resource/images/tablePagination/last.png",
			nextArrow : (new Image()).src="../../resource/images/tablePagination/next.png",
			rowsPerPage : 5,
			currPage : 1,
      ...
      function createPaginationElements() {
        ...
        htmlBuffer.push("<select style='visibility: hidden' id='tablePagination_rowsPerPage'><option value='5'>5</option></select>");
        //htmlBuffer.push("per page");
        htmlBuffer.push("</span>");
        htmlBuffer.push("<span id='tablePagination_paginater'>");
			htmlBuffer.push("<div id='tablePagination_firstPage'></div>");
			htmlBuffer.push("<div id='tablePagination_prevPage'></div>");
        ...
        //htmlBuffer.push("<img id='tablePagination_lastPage' src='"+defaults.lastArrow+"'>");
			htmlBuffer.push("<div id='tablePagination_nextPage'></div>");
			htmlBuffer.push("<div id='tablePagination_lastPage'></div>");
        htmlBuffer.push("</span>");
        htmlBuffer.push("</div>");
