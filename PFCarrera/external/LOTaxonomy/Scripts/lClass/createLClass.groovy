/**
 * Creates a new learning class.
 * @param base The base of learning class repository.
 * @param path The path of learning class.
 * @param host The host for learning class namespace.
**/
def base = '/temp/'
def path = 'LO/Evaluation/Question/'
def host = 'http://ltcs.uned.es/'

createLClass (base, path, host)
...
def createLClass (String base,
    ...
    println path 'lClass successfully created'
}
